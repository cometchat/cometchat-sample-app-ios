...
[![CocoaPods](https://img.shields.io/badge/pod-v1.8.2-green.svg)](https://cocoapods.org/pods/CometChatPro)
...
target 'MyApp' do
  pod 'CometChatPro', '~> 1.8.2'
end 
```
## Install Manually

## First: Download CometChatPro [Here](https://github.com/cometchat-pro/ios-chat-sdk/archive/1.8.2.zip)
## Second :
