...
extension AudioErrorType: LocalizedError {
     var errorDescription: String? {
        switch self {
        case .alreadyRecording:
            return "CURRENTLY_RECORDING".localize()
        case .alreadyPlaying:
            return "CURENTLY_PLAYING".localize()
        case .notCurrentlyPlaying:
            return "CURENTLY_NOT_PLAYING".localize()
        case .audioFileWrongPath:
            return "INVALID_PATH_FOR_AUDIO".localize()
        case .recordFailed:
            return "UNABLE_TO_RECORD_ERROR".localize()
        case .playFailed:
            return "UNABLE_TO_PLAY_ERROR".localize()
        case .recordPermissionNotGranted:
            return "UNABLE_TO_RECORD_PERMISSION".localize()
        case .internalError:
            return "ERROR_OCCOURD_DURING_RECORD".localize()
        }
    }
}
