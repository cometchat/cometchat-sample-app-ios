...
extension UITableView {
    func scrollToBottomRow(isAnimated: Bool = true) {
        ...
        guard let this = self else { return }
            ...
            this.scrollToRow(at: indexPath, at: .bottom, animated: isAnimated)
        }
    }
...
extension UITableView {
    ...
    func scrollToLastVisibleCell(lastIndex: IndexPath) {
        DispatchQueue.main.async { [weak self] in
            guard let this = self else { return }
            guard this.indexPathIsValid(lastIndex) else { return }
            this.scrollToRow(at: lastIndex, at: .bottom, animated: true)
        }
