...
- (MessageRequestBuilder * _Nonnull)setCategoryWithCategory:(NSString * _Nonnull)category SWIFT_WARN_UNUSED_RESULT;
- (MessageRequestBuilder * _Nonnull)setTypeWithType:(NSString * _Nonnull)type SWIFT_WARN_UNUSED_RESULT;
