   ...
   func test007CreatePublicGroupWithEmptyGUID() {
    ...
    func test010CreatePublicGroupWithPassword() {
        ...
        CometChat.createGroup(group: newGroup, onSuccess: { (group) in
            ...
            print("createPublicGroupWithPassword hasJoined: \(newGroup.hasJoined)")
   ...
   func test012CreatePrivateGroupEmptyGUID() {
    ...
    func test023CreatePasswordGroupAlreadyExist() {
        ...
        CometChat.createGroup(group: newGroup, onSuccess: { (group) in
            ...
            print("createPasswordGroupAlreadyExist onSuccess: \(group.stringValue())")
             ...
             //FIXME: createPasswordGroupAlreadyExist : Error Message is not correct
    ...
    func test037CreatePublicGroupWithIconAndDescriptionAndEmptyMetadata(){
        ...
        CometChat.createGroup(group: newGroup, onSuccess: { (group) in
            ...
            print("testCreatePublicGroupWithIconAndDescriptionAndEmptyMetadata hasJoined: \(newGroup.hasJoined)")
...
/////////////////////////// COMETCHATPRO: JOIN/LEAVE/GET GROUP /////////////////////////////
    ...
    func test041LeaveJoinedPublicGroup(){
        ...
        CometChat.leaveGroup(GUID: TestConstants.grpPublic1, onSuccess: { (isSuccess) in
...
//                }
    ...
    func test048JoinPublicGroup(){
        ...
        CometChat.joinGroup(GUID: TestConstants.grpPublic1, groupType: .public, password: nil
            ...
            XCTAssertEqual(error?.errorDescription, "The user with uid superhero1 has already joined the group with guid supergroup.")
            expectation.fulfill()
        }
        wait(for: [expectation], timeout: 10)
    }
    ...
    func test051GetJoinedPasswordGroupInfo() {
        ...
        CometChat.getGroup(GUID: TestConstants.grpPwd5, onSuccess: { (group) in
            ...
            XCTAssertEqual(error?.errorDescription, "The user with superhero1 is not a member of the group with guid 12345. Please join the group to access it.")
            expectation.fulfill()
    ...
    func test054LeaveJoinedPasswordGroup(){
        ...
        CometChat.leaveGroup(GUID: TestConstants.grpPwd5, onSuccess: { (onSuccess) in
            ...
            XCTAssertEqual(error?.errorDescription, "The user with \(TestConstants.user1) is not a member of the group with guid 12345. Please join the group to access it.")
             expectation.fulfill()
...
//        }
        ...
        CometChat.updateGroup(group: newGroup, onSuccess: { (group) in
            ...
            print("testUpdateExistingGroupWithInvalidUserScope onSuccess: \(group.stringValue())")
...
///////////////////// COMETCHATPRO: GROUP ACTIONS : BAN MEMBER //////////////////////////////
    ...
    func test098BanGroupMember(){
        ...
        CometChat.banGroupMember(UID: "superhero2", GUID: TestConstants.grpPublic1, onSuccess: { (success) in
...
///////////////////// COMETCHATPRO: GROUP ACTIONS : UNBAN MEMBER////////////////////////////
    ...
    func test105UnbanGroupMember(){
        ...
        CometChat.unbanGroupMember(UID: "superhero4", GUID: TestConstants.grpPublic1, onSuccess: { (success) in
...
/////////////////COMETCHATPRO: GROUP ACTIONS : FETCH BANNED MEMBERS ////////////////////////
    ...
    func test112FetchBannedGroupMembersWithValidLimit(){
      let expectation = self.expectation(description: "testFetchBannedGroupMembers")
      let bannedMembersRequest = BannedGroupMembersRequest.BannedGroupMembersRequestBuilder(guid: TestConstants.grpPublic1).set(limit: 30).build()
        bannedMembersRequest.fetchNext(onSuccess: { (bannedMembers) in
            print("testFetchBannedGroupMembersWithValidLimit onSuccess: \(bannedMembers))")
...
///////////////////////  COMETCHATPRO: GROUP ACTIONS : CHANGE SCOPE ////////////////////////
    ...
    func test124ChangeScopeOfMemberToParticipant(){
        ...
        CometChat.updateGroupMemberScope(UID: "superhero2", GUID: TestConstants.grpPublic1, scope: .participant, onSuccess: { (sucess) in
    ...
    func test125ChangeScopeOfMemberToModorator(){
        ...
        CometChat.updateGroupMemberScope(UID: "superhero3", GUID: TestConstants.grpPublic1, scope: .moderator, onSuccess: { (sucess) in
    ...
    func test126ChangeScopeOfMemberToAdmin(){
        ...
        CometChat.updateGroupMemberScope(UID: "superhero3", GUID: TestConstants.grpPublic1, scope: .admin, onSuccess: { (sucess) in
...
//        }
        ...
        CometChat.kickGroupMember(UID: "superhero2", GUID: TestConstants.grpPublic1, onSuccess: { (success) in
...
/////////////////////////////   COMETCHATPRO: DELETE GROUP  ////////////////////////////////
    ...
    func test150DeleteGroup(){
      let expectation = self.expectation(description: "testDeleteGroup")
        CometChat.deleteGroup(GUID: TestConstants.grpPublic1, onSuccess: { (sucess) in
