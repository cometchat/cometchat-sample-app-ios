...
extension CometChatKingfisherWrapper where Base: CFCrossPlatformImage {
    ...
    public var normalized: CFCrossPlatformImage { return base }
    ...
    public var normalized: CFCrossPlatformImage {
...
extension CometChatKingfisherWrapper where Base: CFCrossPlatformImage {
    ...
    public static func animatedImage(data: Data, options: ImageCreatingOptions) -> CFCrossPlatformImage? {
        let info: [String: Any] = [
    ...
    ///            will be returned.
    public static func image(data: Data, options: ImageCreatingOptions) -> CFCrossPlatformImage? {
        var image: CFCrossPlatformImage?
    ...
    public static func downsampledImage(data: Data, to pointSize: CGSize, scale: CGFloat) -> CFCrossPlatformImage? {
