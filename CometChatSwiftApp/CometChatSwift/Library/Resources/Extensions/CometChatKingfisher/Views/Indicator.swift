...
public protocol Indicator {
    ...
    /// Center offset of the indicator. CometChatKingfisher will use this value to determine the position of
    ...
    func sizeStrategy(in imageView: CFCrossPlatformImageView) -> IndicatorSizeStrategy
}
...
extension Indicator {
    ...
    public func sizeStrategy(in imageView: CFCrossPlatformImageView) -> IndicatorSizeStrategy {
        return .full
    }
}
...
final class ImageIndicator: Indicator {
    private let animatedImageIndicatorView: CFCrossPlatformImageView
    ...
    init?(
        ...
        options: CometChatKingfisherParsedOptionsInfo? = nil)
    {
        var options = options ?? CometChatKingfisherParsedOptionsInfo(nil)
        ...
        animatedImageIndicatorView = CFCrossPlatformImageView()
