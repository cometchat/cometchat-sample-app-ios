...
public typealias CometChatKingfisherOptionsInfo = [CometChatKingfisherOptionsInfoItem]
...
public struct CometChatKingfisherParsedOptionsInfo {
    ...
    public var onFailureImage: Optional<CFCrossPlatformImage?> = .none
    ...
    public init(_ info: CometChatKingfisherOptionsInfo?) {
