  ...
  enum MemoryStorage {
    ...
    /// items from memory.
     class Backend<T: CacheCostCalculable> {
        ...
        // See https://github.com/onevcat/CometChatKingfisher/issues/1233
        var keys = Set<String>()
        ...
        // The no throw version for storing value in cache. CometChatKingfisher knows the detail so it
