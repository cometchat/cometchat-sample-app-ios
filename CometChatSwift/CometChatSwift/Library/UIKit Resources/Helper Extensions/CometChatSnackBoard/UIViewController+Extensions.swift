...
extension UIViewController {
    ...
    func sm_selectPresentationContextTopDown(_ config: CometChatSnackBoard.Config) -> UIViewController {
    ...
    func sm_selectPresentationContextBottomUp(_ config: CometChatSnackBoard.Config) -> UIViewController {
        let topBottomStyle = config.presentationStyle.topBottomStyle
...
extension CometChatSnackBoard.PresentationStyle {
