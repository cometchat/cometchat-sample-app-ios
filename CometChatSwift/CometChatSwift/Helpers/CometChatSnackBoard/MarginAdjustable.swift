...
/*
 ...
 `layoutMargins` adjusted by CometChatSnackBoard to account for the height of the
...
public protocol MarginAdjustable {
    ...
    /// When `true`, CometChatSnackBoard automatically collapses layout margin additions (topLayoutMarginAddition, etc.)
