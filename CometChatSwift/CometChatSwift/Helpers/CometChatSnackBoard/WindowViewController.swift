...
open class WindowViewController: UIViewController
{
    ...
    convenience public init() {
        self.init(config: CometChatSnackBoard.Config())
    }

    public init(config: CometChatSnackBoard.Config) {
        self.config = config
    ...
    let config: CometChatSnackBoard.Config
}

extension WindowViewController {
    static func newInstance(config: CometChatSnackBoard.Config) -> WindowViewController {
