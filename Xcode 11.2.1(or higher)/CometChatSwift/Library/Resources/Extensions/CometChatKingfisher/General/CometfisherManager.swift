...
public struct PropagationError {
    ...
    public let error: CometChatKingfisherError
}
...
public class CometChatKingfisherManager {
    ...
    public static let shared = CometChatKingfisherManager()
    ...
    public var defaultOptions = CometChatKingfisherOptionsInfo.empty
